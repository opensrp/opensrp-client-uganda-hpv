...
public class LocationHelperTest {
    ...
    @Test
    public void testGetChildLocationIdsForJambulaGirlsSchool() {

        try {
            LocationHelper locationHelper = LocationHelper.getInstance();
            locationHelper.setApplication(application);

            Mockito.when(application.getContext()).thenReturn(context);
    ...
    @Test
    public void testGetChildLocationIdsForNsaloGirlsSchool() {
