 ...
 */
public class HPVRegisterActivityPagerAdapter extends FragmentPagerAdapter {
    private static final String ARG_PAGE = "page";
    private final Fragment mBaseFragment;
    private final FragmentManager fragmentManager;
    private final Fragment[] fragments;

    public HPVRegisterActivityPagerAdapter(FragmentManager fragmentManager, Fragment baseFragment, Fragment[] fragments) {
