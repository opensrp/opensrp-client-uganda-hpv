...
import org.smartregister.ug.hpv.domain.UniqueId;
...
public class UniqueIdRepository extends BaseRepository {
    ...
    public UniqueIdRepository(HpvRepository hpvRepository) {
        super(hpvRepository);
    }
    ...
    public void bulkInserOpenmrsIds(List<String> ids) {
        ...
        try {
            String userName = HpvApplication.getInstance().getContext().allSharedPreferences().fetchRegisteredANM();
