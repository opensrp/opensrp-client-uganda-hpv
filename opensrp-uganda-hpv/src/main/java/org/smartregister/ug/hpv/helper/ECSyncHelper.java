...
import static org.smartregister.ug.hpv.util.Constants.LAST_CHECK_TIMESTAMP;
import static org.smartregister.ug.hpv.util.Constants.LAST_SYNC_TIMESTAMP;
...
public class ECSyncHelper implements PrefsHelper {
    ...
    public static ECSyncHelper getInstance(Context context) {
        if (instance == null) {
            instance = new ECSyncHelper(context, HpvApplication.getInstance().getEventClientRepository());
        }
        return instance;
    }
