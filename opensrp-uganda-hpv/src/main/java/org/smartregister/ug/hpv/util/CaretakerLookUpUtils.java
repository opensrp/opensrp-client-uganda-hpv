...
import static org.smartregister.repository.ChildRepository.CHILD_TABLE_NAME;
 ...
 */
public class CaretakerLookUpUtils {
    private static final String TAG = CaretakerLookUpUtils.class.getName();
    ...
    public static void caretakerLookUp(final Context context, final EntityLookUp entityLookUp, final Listener<HashMap<CommonPersonObject, List<CommonPersonObject>>> listener, final ProgressBar progressBar) {
    ...
    private static HashMap<CommonPersonObject, List<CommonPersonObject>> lookUp(Context context, EntityLookUp entityLookUp) {
        ...
        String tableName = MOTHER_TABLE_NAME;
        String childTableName = CHILD_TABLE_NAME;
