 ...
 */
public class HpvRepository extends Repository {

    private static final String TAG = HpvRepository.class.getCanonicalName();
    protected SQLiteDatabase readableDatabase;
    protected SQLiteDatabase writableDatabase;

    public HpvRepository(Context context, org.smartregister.Context openSRPContext) {
        super(context, AllConstants.DATABASE_NAME, AllConstants.DATABASE_VERSION, openSRPContext.session(), HpvApplication.createCommonFtsObject(), openSRPContext.sharedRepositoriesArray());
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Log.w(HpvRepository.class.getName(),
    ...
    public SQLiteDatabase getReadableDatabase() {
        return getReadableDatabase(HpvApplication.getInstance().getPassword());
    }

    @Override
    public SQLiteDatabase getWritableDatabase() {
        return getWritableDatabase(HpvApplication.getInstance().getPassword());
    }
