...
package org.smartregister.ug.hpv.barcode;
...
public class BarcodeIntentIntegrator {
    ...
    private AlertDialog showDownloadDialog() {
        AlertDialog.Builder downloadDialog = new AlertDialog.Builder(fragment != null ? fragment.getActivity() : activity, R.style.HpvAlertDialog);
