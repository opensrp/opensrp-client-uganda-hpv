package org.smartregister.ug.hpv.watchers;
...
public class LookUpTextWatcher implements TextWatcher {
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (formFragment instanceof HpvJsonFormFragment) {
            HpvJsonFormFragment hpvJsonFormFragment = (HpvJsonFormFragment) formFragment;
            context = hpvJsonFormFragment.context();
            listener = hpvJsonFormFragment.motherLookUpListener();
        }
